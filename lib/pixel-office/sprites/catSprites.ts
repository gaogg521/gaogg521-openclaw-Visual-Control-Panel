...
let catSpritesOverride: CharacterSprites | null = null

export function setCatSpritesOverride(sprites: CharacterSprites): void {
  catSpritesOverride = sprites
}

export function clearCatSpritesOverride(): void {
  catSpritesOverride = null
}
...
export function getCatSprites(): CharacterSprites {
  if (catSpritesOverride) return catSpritesOverride
